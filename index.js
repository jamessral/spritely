...
Module['FS_createPath']('/assets', 'icons', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/font/white_letter.png", "start": 0, "end": 1604, "audio": 0}, {"filename": "/assets/font/white_letter_blank_background.png", "start": 1604, "end": 3111, "audio": 0}, {"filename": "/assets/font/black_letter.png", "start": 3111, "end": 4692, "audio": 0}, {"filename": "/assets/font/alpha.png", "start": 4692, "end": 5646, "audio": 0}, {"filename": "/assets/font/white_letter.sorted.png", "start": 5646, "end": 12995, "audio": 0}, {"filename": "/assets/font/black_letter_blank_background.png", "start": 12995, "end": 14440, "audio": 0}, {"filename": "/assets/icons/icons.png", "start": 14440, "end": 17642, "audio": 0}, {"filename": "/assets/icons/Load.png", "start": 17642, "end": 17787, "audio": 0}, {"filename": "/assets/icons/Save.png", "start": 17787, "end": 17910, "audio": 0}, {"filename": "/assets/icons/Info.png", "start": 17910, "end": 18057, "audio": 0}, {"filename": "/assets/icons/Fill.png", "start": 18057, "end": 18197, "audio": 0}, {"filename": "/assets/icons/Pen.png", "start": 18197, "end": 18350, "audio": 0}, {"filename": "/assets/icons/Undo.png", "start": 18350, "end": 18477, "audio": 0}, {"filename": "/assets/icons/Drag.png", "start": 18477, "end": 18599, "audio": 0}, {"filename": "/assets/icons/Redo.png", "start": 18599, "end": 18729, "audio": 0}], "remote_package_size": 18729, "package_uuid": "11335967-9c43-457a-a5b1-67154fb5b70c"});
...
var ASM_CONSTS = {
  44700: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 46179: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 47168: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 47261: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 48486: function() {return screen.width;},  
 48513: function() {return screen.height;},  
 48541: function() {return window.innerWidth;},  
 48573: function() {return window.innerHeight;},  
 48651: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 48785: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 48951: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 49177: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 49730: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
